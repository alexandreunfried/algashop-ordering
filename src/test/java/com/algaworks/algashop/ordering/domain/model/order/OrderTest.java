...
import static com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.aBilling;
import static com.algaworks.algashop.ordering.domain.model.order.OrderTestDataBuilder.aShipping;
import static com.algaworks.algashop.ordering.domain.model.product.ProductTestDataBuilder.*;
...
class OrderTest {
	...
	@Test
	void giverDraftOrder_whenChangeBilling_shouldAllowChange() {
	...
	void givenDraftOrderAndDeliveryDateInThePast_whenChangeShipping_shouldNotAllowChange() {
		...
		Shipping shipping = aShipping().toBuilder()
